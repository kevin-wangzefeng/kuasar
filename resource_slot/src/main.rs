...
use crate::sandbox::ResourceSlotSandboxer;
...
async fn main() {
    ...
    env_logger::Builder::from_default_env()
        ...
        .filter_module("resource_slot_sandboxer", log_level)
        .init();
    ...
    let sandboxer = ResourceSlotSandboxer::default();
    containerd_sandbox::run(
        "kuasar-resource-slot-sandboxer",
        &args.listen,
        &args.dir,
        sandboxer,
    )
